          ...
          <div className="animate-slide-in-left">
            <div className="space-y-6 text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
             ...
             Currently working on self-initiated projects, I’m actively building as a Frontend Developer using ReactJS, Tailwind CSS, and JavaScript—with backend experience to support full-stack development. I focus on writing clean, efficient code and delivering intuitive user experiences.
              ...
              <p>I'm also exploring Machine Learning, expanding my skill set to build intelligent, real-world solutions. For me, being a developer isn’t about titles—it’s about building, learning, and shipping things that matter.
                 </p>
            </div>
            ...
            <div className="my-8 text-center">
              <button
                ...
                className="flex items-center gap-3 mx-auto px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-full font-medium hover:shadow-lg transition-all duration-300 text-lg hover:scale-105 hover:-translate-y-0.5"
              >
            ...
            {/* Core Values */}
            <div className="bg-white/10 dark:bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/20 dark:border-white/10 shadow-lg">
              <h3 className="text-xl font-bold mb-6 text-slate-900 dark:text-white text-center">Core Values</h3>
              <div className="grid grid-cols-2 gap-4">
                {values.map((value, index) => (
                  <div
                    key={value.label}
                    className="flex items-center gap-3 p-3 bg-white/10 dark:bg-white/5 backdrop-blur-xl rounded-xl border border-white/20 dark:border-white/10 hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-0.5"
                  >
            ...
            {/* Interests */}
            <div className="mt-8">
              <h3 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">Interests & Hobbies</h3>
              <div className="flex flex-wrap gap-3">
                {interests.map((interest, index) => (
                  <div
                    key={interest.label}
                    className="flex items-center gap-2 px-4 py-2 bg-white/10 dark:bg-white/5 backdrop-blur-xl rounded-full border border-white/20 dark:border-white/10 text-sm font-medium text-blue-500 hover:bg-blue-500 hover:text-white transition-all duration-300 hover:scale-105 hover:-translate-y-0.5"
                  >
          ...
          <div className="animate-slide-in-right">
            <div className="space-y-6">
              {education.map((edu, index) => (
                <div
                  key={index}
                  className="bg-white/10 dark:bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/20 dark:border-white/10 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-102 hover:-translate-y-1"
                >
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-white">{edu.title}</h3>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">{edu.description}</p>
                </div>
              ))}
            </div>
          </div>
